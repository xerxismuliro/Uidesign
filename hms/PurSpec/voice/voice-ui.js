...
} function setupVoiceControlListeners(recognition, container) {const startListeningBtn = document.getElementById('start-listening');const pauseBtn = document.getElementById('pause-listening');
...
} function updateVoiceUIState(state) {const startListeningBtn = document.getElementById('start-listening');
...
} function handleUnsupportedVoiceRecognition(container, voiceStatus) {const startListeningBtn = document.getElementById('start-listening');if (startListeningBtn) startListeningBtn.disabled = true;
